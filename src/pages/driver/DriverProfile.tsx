...
import { Loader2, Star, Clock, DollarSign, Settings, Camera } from 'lucide-react';
...
export default function DriverProfile() {
  ...
  const menuItems = [
    { icon: Clock, label: 'Minhas entregas', onClick: () => navigate('/driver/history') },
    { icon: DollarSign, label: 'Saldo', onClick: () => toast({ title: 'Em breve!' }) },
