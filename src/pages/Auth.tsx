/**
 * /auth — Login de usuários existentes.
 * Cadastro novo: navegar para /register (seleção de perfil).
 */
        ...
        <div className="relative z-10 flex flex-col h-full p-10">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <p className="text-primary-foreground/65 text-base leading-relaxed max-w-xs">
              Conectamos você ao entregador ideal para cada pedido.
            </p>
        ...
        <div className="w-full max-w-sm">
          <div className="mb-7">
            ...
            <p className="text-gray-500 mt-2 text-sm">
              Faça login para continuar na plataforma Levei.ai.
            </p>
          </div>
